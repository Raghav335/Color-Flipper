...
btnClick.addEventListener('click',function changebackColor(){
  let randomColor = getrandomNumber();
  document.body.style.backgroundColor = colorArr[randomColor];
  document.getElementById('clr').innerHTML = colorArr[randomColor];
